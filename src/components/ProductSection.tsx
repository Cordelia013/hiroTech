...
export const ProductSection: React.FC<ProductSectionProps> = () => {
  return (
    <section className={`relative min-h-screen bg-pink-50 px-8 py-4 overflow-hidden z-10`}>
      <Decorations />
      <h2 className="text-[40px] font-bold text-[#FF4B15] mb-8 flex items-start">PRODUCT</h2>
      <div className="pt-28">
      {/* Content */}
